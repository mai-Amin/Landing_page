...
export const siteData = {
  ...
  hero: {
    ...
    desc: "نقدم لك حلولاً رقمية متكاملة تساعدك علي بناء موقعك الإلكتروني واجهة أعمالك الأولى، بتصميم فاخر و احترافي يعكس قوة براند ويزيد مبيعاتك علي مدار الساعه .",
    checks: ["تصميم احترافي", "سرعة و امان", "متوافق مع الجوال"],
  ...
  features: [
    {
      icon: FiPercent,
      title: "بدون اشتراكات او رسوم شهرية",
